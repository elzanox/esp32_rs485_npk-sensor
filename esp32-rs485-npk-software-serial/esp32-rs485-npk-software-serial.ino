...
void setup() {
  ...
  rs485Serial.begin(9600); // Memulai komunikasi dengan baudrate 4800
...
void loop() {
  uint8_t result;
  float registerValues[2]; // Array untuk menyimpan nilai dari register 0x0001 sampai 0x0008

  // Membaca register dari alamat 0x0001 sampai 0x0008
  for (uint8_t i = 0; i < 2; i++) {
    result = node.readInputRegisters(0x0000 + i, 2); // Membaca 1 register
